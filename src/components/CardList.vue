...
let cards = ref([]);
const selectedSort = ref('Без сортировки');
...
const sortProducts = () => {
  ...
  if (selectedSort.value === 'Сначала с высоким рейтингом') {
    cards.value.sort((a, b) => b.rating.rate - a.rating.rate);
  } else if (selectedSort.value === 'Сначала с низким рейтингом') {
...
const changeSelectedSortByRating = () => {
  selectedSort.value = 'Сначала с высоким рейтингом'
}

const changeSelectedSortToDefault = () => {
  selectedSort.value = 'Без сортировки'
}

watch(firstList, changeSelectedSortToDefault);
watch(secondList, changeSelectedSortToDefault);
watch(lastList, changeSelectedSortToDefault);
</script>
  ...
  <div>
    <div class="sortByRating">
      <v-select
          ...
          :items="['Без сортировки', 'Сначала с высоким рейтингом', 'Сначала с низким рейтингом']"
          variant="solo"
    ...
    <section
      ...
      <CardItem
          ...
          @changeSelectedSortByRating="changeSelectedSortByRating"
