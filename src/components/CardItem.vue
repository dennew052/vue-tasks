...
const emits = defineEmits(['changeSelectedSortByRating']);
...
function sortList() {
  ...
  emits('changeSelectedSortByRating');
}

</script>

<template>
  <div v-bind="$attrs" class="card" :style="`box-shadow: 0px 0px 27px 0px ${borderColor}`">
